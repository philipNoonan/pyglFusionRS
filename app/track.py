...
def generateIndexMap(shaderDict, textureDict, bufferDict, fboDict, cameraConfig, fusionConfig, mapSize):
    ...
    glUniformMatrix4fv(glGetUniformLocation(shaderDict['indexMapGeneration'], "K"), 1, False, glm.value_ptr(cameraConfig['K']))
...
def genVirtualFrame(shaderDict, textureDict, bufferDict, fboDict, cameraConfig, fusionConfig, mapSize, frameCount):
    ...
    glUniformMatrix4fv(glGetUniformLocation(shaderDict['surfaceSplatting'], "K"), 1, False, glm.value_ptr(cameraConfig['K']))

    #glUniform4f(glGetUniformLocation(shaderDict['surfaceSplatting'], "cam"), 326, 255, 454, 454)
