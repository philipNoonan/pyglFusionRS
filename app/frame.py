...
def bilateralFilter(shaderDict, textureDict, cameraConfig):
    ...
    glUniform1f(glGetUniformLocation(shaderDict['bilateralFilterShader'], "depthScale"), cameraConfig['depthScale']) 
...
def alignDepthColor(shaderDict, textureDict, cameraConfig, fusionConfig):
    ...
    glUniformMatrix4fv(glGetUniformLocation(shaderDict['alignDepthColorShader'], "colK"), 1, False, glm.value_ptr(cameraConfig['colK']))
    
    #glUniform4f(glGetUniformLocation(shaderDict['alignDepthColorShader'], "cam"), 423, 250, 615, 614) # FIXME
...
def depthToVertex(shaderDict, textureDict, cameraConfig, fusionConfig):
    ...
    glUniform2f(glGetUniformLocation(shaderDict['depthToVertexShader'], "topRight"), cameraConfig['depthWidth'], cameraConfig['depthHeight'])
